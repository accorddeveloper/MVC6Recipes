...
This project contains the code samples for the forthcoming book ASP.NET MVC 6 Recipes by John Ciliberti. 
...
To clone this repository you will need to download the Git command line tool. If you are on Windows running Visual Studio 2015, this tool has been included and can be run from your Visual Studio command prompt. If you are not using Visual Studio you may download Git at http://www.git-scm.com/. 


Once Git is installed, you may clone the repository by typing the following command at the command prompt: 


git clone https://github.com/johnciliberti/MVC6Recipes 
