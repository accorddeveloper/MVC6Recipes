...
using Recipe11.Web.Models;

namespace Recipe11.Web.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override IModel Target
        {
            get
            {
                ...
                builder.Entity("Recipe11.Web.Models.ApplicationUser", b =>
                    {
                ...
                builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]", b =>
                    {
                        b.ForeignKey("Recipe11.Web.Models.ApplicationUser", "UserId");
                    });
